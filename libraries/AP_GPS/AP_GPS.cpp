...
const AP_Param::GroupInfo AP_GPS::var_info[] = {
    ...
    // @Bitmask: 0:Use UART2 for moving baseline on ublox,1:Use base station for GPS yaw on SBF,2:Use baudrate 115200,8:Disable RTCM3 forwarding to MovingBaseline-Rover
    // @User: Advanced
